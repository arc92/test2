...
public function behaviors()
{
    ...
    public function actionShow($id=null){
        ...
        return['status'=>true,'code'=>200,'message'=>null,'data'=>\app\models\Size::find()->asArray()->all()];

        if($id!=null)

        return['status'=>true,'code'=>200,'message'=>null,'data'=>\app\models\Size::find()->where(['catID'=>$id])->asArray()->all()];
