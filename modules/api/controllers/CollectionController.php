...
class CollectionController extends Controller
{
    ...
    if($categoryID==null && $catID==null && $subcatID!=null && $planID!=null  && $colorID==null && $name==null ){
        ...
        foreach (\app\models\Product::find()->Where(['id'=>$arraysub])->andWhere(['planID'=>$planID])->all() as $product) {
            $productItem[$i]['id']=$product->id;
            $productItem[$i]['name']=$product->name;
            $productItem[$i]['price']=$product->price;
            $productItem[$i]['image']=$product->productimgs->img;
...
if($categoryID==null && $catID==null && $subcatID!=null && $planID!=null  && $colorID==null && $name!=null ){
    ...
    foreach (\app\models\Product::find()->Where(['id'=> $array])->andWhere(['id'=>$arraysub])->andWhere(['planID'=>$planID])->all() as $product) {   
        $productItem[$i]['id']=$product->id;
        $productItem[$i]['name']=$product->name;
        $productItem[$i]['price']=$product->price;
        $productItem[$i]['image']=$product->productimgs->img;
...
if($categoryID==null && $catID==null && $subcatID==null && $planID!=null  && $colorID!=null && $name!=null ){
    ...
    foreach (\app\models\Product::find()->Where(['id'=> $array])->andWhere(['planID'=>$planID])->andWhere(['colorID'=>$colorID])->all() as $product) {   
        $productItem[$i]['id']=$product->id;
        $productItem[$i]['name']=$product->name;
        $productItem[$i]['price']=$product->price;
        $productItem[$i]['image']=$product->productimgs->img;
