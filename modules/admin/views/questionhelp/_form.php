...
<div class="questionhelp-form">

    <?php $form = ActiveForm::begin(); ?>

    <?= $form->field($model, 'cathelpID')->dropDownList(ArrayHelper::map(\app\models\Cathelp::find()->all(), 'id', 'name')) ?>

    
    <?= $form->field($model, 'question')->widget(\dominus77\tinymce\TinyMce::className(), [    
    'options' => [
        'rows' => 6,
        'placeholder' => true,
    ], 
    ...
    <?= $form->field($model, 'answer')->widget(\dominus77\tinymce\TinyMce::className(), [    
    'options' => [
        'rows' => 6,
        'placeholder' => true,
    ], 
