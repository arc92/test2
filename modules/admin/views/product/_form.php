...
<label class="control-label" for="product-cat_relation1">دسته بندی</label> 
  <select id="product-cat_relation1" class="form-control " name="cat_relation[]" multiple="multiple"  krajee-select2="select2_da38a72a" > 
<?php 
...
<select id="product-subcat_relation1" class="form-control  " name="subcat_relation[]" multiple="multiple"  krajee-select2="select2_da38a72a" > 
<?php 
...
<?php if($model->isNewRecord==null){ 
     ...
     <label class="control-label" for="aboutproduct-details">مشخصات محصول</label>  
       <input type="text"  class="form-control" name="details[<?=$_about->id?>]" value="<?=$aboutproductmodellitems->details?>" maxlength="512" aria-invalid="true">
...
<div id="p">
    ...
    <?php } ?>
      ...
      <input type="text"  class="form-control" name="value[<?=$_feature->id?>]" value="<?=$featurevaluemodelitems->value?>">

      <div class="help-block"></div>
      </div>
      <div class="form-group field-featurevalue-price">
      <label class="control-label" for="featurevalue-price">قیمت</label>
      <input type="text" class="form-control" name="price[<?=$_feature->id?>]" value="<?=$featurevaluemodelitems->price?>">

      <div class="help-block"></div>
      </div>
      <div class="form-group field-featurevalue-count">
      <label class="control-label" for="featurevalue-count">تعداد</label>
      <input type="text"  class="form-control" name="count[<?=$_feature->id?>]" value="<?=$featurevaluemodelitems->count?>">
...
<select id="detailsvalue-detailsid" class="form-control" name="detailsID[<?=($_details->detailsID)?>]" value="<?=$_details->id?>">
...
<input type="text" id="detailsvalue-title" class="form-control" name="titledetails[<?=($_details->id)?>]" maxlength="255" value="<?=$detailsvaluemodelitems->title?>">
...
<input type="text" id="detailsvalue-value" class="form-control" name="valuedetails[<?=($_details->id)?>]" maxlength="50" value="<?=$detailsvaluemodelitems->value?>">
