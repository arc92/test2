...
option = {
    ...
    series : [
        ...
        },
        {
            ...
            markPoint : {
                data : [
                    {name : 'بالاترین سال', value : 182.2, xAxis: 7, yAxis: 183, symbolSize:18},
                    {name : 'حداقل سال', value : 2.3, xAxis: 11, yAxis: 3}
                ]
            },
            markLine : {
                data : [
...
option = {
    ...
    legend: {
        x : 'center',
        y : 'bottom',
        data:['گزارش8','گزارش7','گزارش6','گزارش5','گزارش4','گزارش3','گزارش2','گزارش1']
    },
    toolbox: {
        show : true,
        feature : {
    ...
    series : [
        {
            ...
            data:[
                {value:10, name:'گزارش1'},
                {value:5, name:'گزارش2'},
                {value:15, name:'گزارش3'},
                {value:25, name:'گزارش4'},
                {value:20, name:'گزارش5'},
                {value:35, name:'گزارش6'},
                {value:30, name:'گزارش7'},
                {value:40, name:'گزارش8'}
            ]
        },
        {
            name:'حالت منطقه',
...
option = {
    ...
    polar : [
       {
           indicator : [
               { text: 'فروش ها', max: 6000},
               { text: 'مدیریت', max: 16000},
               { text: 'فناوری اطلاعات', max: 30000},
               { text: 'پشتیبانی مشتری', max: 38000},
               { text: 'توسعه', max: 52000},
               { text: 'بازار یابی', max: 25000}
            ]
        }
    ],
    color: ["#55ce63", "#009efb"],
...
option = {
    ...
    legend: {
        orient : 'vertical',
        x : 'left',
        data:['آیتم الف','آیتم ب','آیتم ج','آیتم د','آیتم هـ']
    },
    toolbox: {
        show : true,
        feature : {
    ...
    series : [
        {
            ...
            data:[
                {value:335, name:'آیتم الف'},
                {value:310, name:'آیتم ب'},
                {value:234, name:'آیتم ج'},
                {value:135, name:'آیتم د'},
                {value:1548, name:'آیتم هـ'}
            ]
        }
    ]
};
