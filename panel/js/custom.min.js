$(function () {
    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function () {
        ...
        i(o).each(function () {
            var e = i(this), s = e.closest(".card"), o = s.find(".card-body"), r = {toggle: !1};
            ...
            e.preventDefault();
            var s = i(this).closest(".card"), o = s.find(".card-body");
            o.collapse("toggle")
        })
...
$('#sync-data').click(function (e) {
    $('#sync-loding-img').show();


    $.ajax({
        url: "/api/search/index-data",
        method: "GET",
        timeout: 0,
        success: function(html){
            $('#sync-loding-img').hide();
        },
        complete: function(){
            $('#sync-loding-img').hide();
        }
