                ...
                <div class="order-map" style="overflow-x: hidden ; overflow-y: hidden">
                    <div  >
                        <div class="tbody" style="cursor: pointer;">
                            ...
                            <input type="radio" name="catproduct" value="" style="display:none!important;" >
                                <div class="tr d-flex">
                                    <?php
                                     $strname=str_replace('-', ' ',$_GET['name']);
                                     $plan=\app\models\Plan::find()->Where(['name'=>$strname])->one(); 
                                    ?>
                                <input type="radio" name="planproduct" value="<?=$plan->id?>" style="display:none!important;" >
    ...
    <div class="item">
        <div class="details-item">
            ...
            <a href="/product/<?=str_replace(' ', '-',$article->name)?>/">
                <img src="/<?=(isset($article->productimgs->img))?$article->productimgs->img:'' ?>" alt="">
            </a>
            <div class="text">
                <h3 class="title">
                    <?=$article->name?>
