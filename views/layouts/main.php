...
"name":"<?= $product->name ?>","image":"https://www.bccstyle.com/<?= $img->img ?>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse mr-auto" id="navbarNav">
                        <ul class="navbar-nav ">
                            ...
                            <li class="nav-item">
                                <a href="https://www.bccstyle.com/baby-clothing/discounts/" class="nav-link" id="navbarDropdown" style="color: #ed008c!important;">
                                    تخفیفی
                                </a>
                            </li>
                                                ...
                                                foreach ($products as $product) {
                                                    if ($product->id == $cartoption->productID) {
                                                        ...
                                                        <div class="item">
                                                            <div class="right">
                                                                <div class="image">
                                                                    <img src="/<?= $product->productimgs->img ?>"
                                                                         alt="">
                                                                </div>
                                                                <div class="detail">
