                ...
                <div class="details-item">
                 <!-- if( $article->checkCount() ){?>
                      ...
                      <ul class="nav">
                          ...
                          <li class="nav-item">
                          <a href="/product/<?=$article->id?>/<?=str_replace(' ', '-',$article->name)?>/">   <i class="icon-003-buy"></i></a>
                          </li>
                      ...
                      <a href="/product/<?=$article->id?>/<?=str_replace(' ', '-',$article->name)?>/">
        ...
        <?php foreach ($articles as $article) {  ?>
            <div class="item item-line">
                ...
                <a href="/product/<?=$article->id?>/<?=str_replace(' ', '-',$article->name)?>/">
                    ...
                    <a href="/product/<?=$article->id?>/<?=str_replace(' ', '-',$article->name)?>/" class="show">
                       <span>
                       مشاهده محصول
                       </span>
                          </a>
