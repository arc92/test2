...
<section class="show container p-0 d-flex  align-items-center justify-content-between">
        ...
        <?= $form->field($model, 'planID', ['options' => ['style' => 'display:inline-block;']])->dropDownList(ArrayHelper::map(\app\models\Plan::find()->all(), 'id', 'name'),['prompt'=>'انتخاب طرح..','class'=>'js-example-basic-single auto'])->label('') ?>
                ...
                <div class="details-item">
                 ...
                 ?>
                      <ul class="nav">
                          ...
                          <li class="nav-item">
                          <a href="/product/<?=$article->id?>">   <i class="icon-003-buy"></i></a>
                          </li>
            ...
            <div class="item item-line">
                ...
                <a href="/product/<?=$article->id?>">
                    ...
                    <div class="introduciton">
                        ...
                        <span class="price ">  <?=$article->price?>  تومان </span>
                    </div>
                    ...
                    <a href="/product/product/<?=$article->id?>" class="show">
                       <span>
                       مشاهده محصول
                       </span>
                          </a>
  ...
  $.get(url,(data,status)=>{
      ...
      console.log(status); 
                ...
                $.each(data.data, function(index, value) { 
                        ...
                        if(value.offer!=null ){
                        html+='<label class="badge off">'+value.offer+'%</label> '; 
                        }  
                        if(value.count==1 ){
                        html+='<label class="badge off">ناموجود</label> '; 
                        } 
                        html+=' <a target="_blank" href="/product/'+value.id+'">'; 
                        html+='<img src="/'+value.image+'">'; 
                        html+='<div class="text">';
                        html+=' <h3 class="title">'+value.name+'</h3>     ';                         
                        html+=' <span class="price">  '+value.price+'  تومان </span>';
                        html+=' </div>';
                        html+=' </a>';
                        html+='</div>'; 
                        html+='</div>'; 
...
<!-- // jQuery('#product-catid').change(()=>{
//     var html='';
//     $.get("http://localhost:8080/api/product/"+jQuery('#product-catid').val()+jQuery('#product-subcatid').val()+jQuery('#product-planid').val()).done((data,status)=>{
//       console.log(data);
//       console.log(status); -->
    ...
    <!-- // var url=("http://localhost:8080/api/product?catID="+jQuery('#product-catid').val()+"&subcatID="+jQuery('#product-subcatid').val()+"&planID="+jQuery('#product-planid').val());
    // alert(url); -->
