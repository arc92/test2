...
<ul class="nav">
   ...
   <section class="filter-sec one list">
    ...
    <div class="alert alert-danger col-md-12 text-center" style="font-size:25px;margin-top:100px;margin-bottom:100px;">
              ...
              <div class="item">
                ...
                <div class="details-item">
                      ...
                      <ul class="nav">
                          ...
                          <li class="nav-item">
                          <a href="/product/<?=$item->id?>/<?=str_replace(' ', '-',$item->name)?>/">   <i class="icon-003-buy"></i></a>
                          </li>
                          <li class="nav-item icon-like liked">
                              <i class="icon-012-like" id="like<?=$item->id?>"  data-like="<?=$item->id?>"></i>
                          </li>
                      </ul>

                       <script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
                        <script>
                            jQuery('#like<?=$item->id?>').on('click',function(e){
                                e.preventDefault();
                                ...
                                $.ajax({
                                        ...
                                        sessionStorage.setItem('<?=$item->id?>', data); 
                                    });  
                            });
                            $("#like<?=$item->id?>").click(function() {
                                $("#like<?=$item->id?>").css("color", "red"); 
                            });
                        </script> 
                      <a href="/product/<?=$item->id?>/<?=str_replace(' ', '-',$item->name)?>/">  

                      <img src="/<?=$item->productimgs->img ?>" alt="">
                      ...
                      <div class="text">
                          ...
                          <?php }else{?>
                          <?php if($offer=\app\models\Offer::find()->Where(['planID'=>$item->planID])->one()){?>
                          <div class="price-item d-flex " >
                               <del class="price-deleted" style="color:#5e5e5e!important;">   <?=number_format($item->price)?>   </del>
                               <span class="price"> 
                        ...
                        <?=$offer->percent?>%
                            ...
                            <div class="price-item d-flex ">
                                ...
                                <?=number_format($item->price-($item->price*$offer->percent)/100)?> هزار تومان
                               </span>
                              
                           </div> 
                    
                      <?php  }else{ ?> 
                        <span class="price"><?=number_format($item->price)?>   هزار تومان  </span>
                      <?php } } ?>
                ...
                <a href="/product/<?=$item->id?>/<?=str_replace(' ', '-',$item->name)?>/">
                    ...
                    <ul class="nav attr d-block">
                        ...
                        <?php foreach($aboutproducts as $aboutproduct){
                            if($aboutproduct->productID==$item->id){ ?>
                        <li class="nav-item"> 
                    ...
                    <a href="/product/<?=$item->id?>/<?=str_replace(' ', '-',$item->name)?>/" class="show">
                       <span>
                       مشاهده محصول
                       </span>
                          </a>
